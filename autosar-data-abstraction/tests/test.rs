...
mod test {
    ...
    use autosar_data_abstraction::{
        communication::{
            ...
            NetworkEndpointAddress, SocketAddressType, TpConfig, TransferProperty,
        },
    ...
    fn create_can_system() {
        ...
        let pdu2signal1 = system
            .create_signal("P2S1", 4, &isignal_package, &syssignal_package)
            .unwrap();
        let pdu2signal2 = system
            .create_signal("P2S2", 4, &isignal_package, &syssignal_package)
            .unwrap();
        pdu2.map_signal(
            &pdu2signal1,
            0,
